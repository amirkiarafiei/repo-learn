            ...
            <header className="border-b border-zinc-800 px-4 py-3">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <span className="text-zinc-400 text-sm">Tutorial:</span>
            ...
            <div className="flex-1 flex">
                ...
                >
                    ...
                    <button
                        ...
                        className="w-full p-3 flex items-center justify-center hover:bg-zinc-800/50 transition-colors border-b border-zinc-800"
                    >
                        <svg
                            className={`w-5 h-5 text-zinc-400 transition-transform ${sidebarOpen ? "" : "rotate-180"}`}
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                        >
